...
public class IluminacaoRuimFactory extends AbstractRelatoFactory {
    ...
    public Relatos criarRelato(String tipo, String descricao, String data, String endereco, String cidade, int nivelPreocupacao, Object... parametrosAdicionais) {
        if (parametrosAdicionais.length >= 2) {
            ...
            return new IluminacaoRuim(descricao, data, endereco, cidade, nivelPreocupacao, qtdLampadasQueimadas, nivelIluminacao);
        }
    ...
    public IluminacaoRuim criarIluminacaoRuim(String descricao, String data, String endereco, String cidade, int nivelPreocupacao, int qtdLampadasQueimadas, int nivelIluminacao) {
        return new IluminacaoRuim(descricao, data, endereco, cidade, nivelPreocupacao, qtdLampadasQueimadas, nivelIluminacao);
    }
} 