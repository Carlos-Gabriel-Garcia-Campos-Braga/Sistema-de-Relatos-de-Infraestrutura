...
public class SemaforoProblemaFactory extends AbstractRelatoFactory {
    ...
    public Relatos criarRelato(String tipo, String motivo, String descricao, 
        ...
        if (parametrosAdicionais.length >= 1) {
            ...
            return new SemaforoProblema(motivo, descricao, data, endereco, cidade, 
    ...
    public SemaforoProblema criarSemaforoProblema(String motivo, String descricao, String data, 
